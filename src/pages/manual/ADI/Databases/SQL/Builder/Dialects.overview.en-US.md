...
| `slice()` offset-only | `OFFSET n` | `LIMIT 18446744073709551615 OFFSET n` | `LIMIT -1 OFFSET n` |
...
| Enum | Cases |
|------|-------|
| `Aggregates` | `Average`, `Count` (since 1.0.3), `Maximum`, `Minimum`, `Sum` |
...
Since v0.22.0-beta, every dialect has a matching native wire driver — the SQL that MySQL and
