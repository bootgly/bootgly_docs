...
Fields are asked one at a time inside fieldset frames — cyan legend while editing, dim once answered; the Secret field echoes `•` per character; the summary Fieldset + confirm Menu let you edit any field before submitting.
</d-block-terminal>
