...
Os campos são perguntados um por vez dentro de quadros fieldset — legend ciano durante a edição, esmaecida depois de respondido; o campo Secret ecoa `•` por caractere; o Fieldset de resumo + Menu de confirmação permitem editar qualquer campo antes de submeter.
</d-block-terminal>
