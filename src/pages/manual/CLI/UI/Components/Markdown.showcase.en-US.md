...
A full-featured document renders at once: styled headings, wrapped paragraphs with emphasis and inline code, nested lists and tasks, a fenced PHP block, stacked quotes, an aligned table and a rule.
...
<d-block-terminal
  ...
  height="520"
>
A markdown document painted with raw SGR styling: headings, lists, tasks, quotes, fenced code, an aligned table and links. Use the source button to read the PHP file.
</d-block-terminal>
