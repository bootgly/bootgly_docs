...
Três variações de moldura (conteúdo mais largo que o título, título mais largo que o conteúdo, e sem título), seguidas de composição: um `Select` inteiro renderizado **dentro** de um Fieldset ao colocar o Select em modo `RETURN_OUTPUT` e usar sua saída como conteúdo do Fieldset.
