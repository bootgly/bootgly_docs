...
Com `Sources::Cookies`, as regras ligam pelo nome do cookie; quando o mesmo nome aparece em múltiplas linhas `Cookie`, a primeira linha vence — espelhando `Cookies::get()`.
