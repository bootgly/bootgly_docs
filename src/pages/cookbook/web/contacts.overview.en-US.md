...
The API keeps its contacts in **SQLite**, which needs PHP's `sqlite3` extension. This line installs it with your package manager only when it is missing (the official Docker images build it in):
